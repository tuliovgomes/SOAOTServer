...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = 0, maxDamage = -790, range = 7, shootEffect = CONST_ANI_WHIRLWINDAXE, target = true}
}
