...
monster.attacks = {
	...
	{name ="sudden death rune", interval = 2000, chance = 16, minDamage = -2400, maxDamage = -600, target = true},
	{name ="combat", interval = 2000, chance = 13, type = COMBAT_HOLYDAMAGE, minDamage = -1450, maxDamage = -2640, length = 7, spread = 3, effect = CONST_ME_HOLYAREA, target = false},
	{name ="combat", interval = 2000, chance = 15, type = COMBAT_EARTHDAMAGE, minDamage = -1480, maxDamage = -2630, radius = 5, effect = CONST_ME_EXPLOSIONHIT, target = false}
}
