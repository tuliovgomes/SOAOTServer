...
monster.loot = {
	...
	{name = "crystal coin", minCount = 1, maxCount = 35, chance = 50000},
	...
	{name = "gold token", minCount = 0, maxCount = 10, chance = 18000},
	{name = "silver token", minCount = 0, maxCount = 15, chance = 25000},
...
monster.attacks = {
	{name = "melee", type = COMBAT_PHYSICALDAMAGE, interval = 2000, minDamage = -2900, maxDamage = -4700},
	...
	{name = "combat", type = COMBAT_LIFEDRAIN, interval = 2000, chance = 10, length = 8, spread = 3, minDamage = -600, maxDamage = -4600, effect = CONST_ME_SMALLCLOUDS},
}
