...
monster.health = 264000
monster.maxHealth = 264000
monster.race = "venom"
...
monster.attacks = {
	...
	{name ="melee", interval = 2000, chance = 12, minDamage = -430, maxDamage = -560, target = false},
	{name ="melee", interval = 2000, chance = 12, minDamage = -230, maxDamage = -460, target = false},
	{name ="melee", interval = 2000, chance = 12, minDamage = -430, maxDamage = -660, target = false}
}
